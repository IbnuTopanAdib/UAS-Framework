...
<head>
    ...
    <title>Magang Fasilkom Ibnu</title>
...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Magang Fasilokm</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link @yield('active0')" aria-current="page" href="/dashboard">
                                <span data-feather="home" class="align-text-bottom"></span>
                                Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @yield('active1')" aria-current="page" href="/magang">
                                <span data-feather="file-text" class="align-text-bottom"></span>
                                Magang
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @yield('active2')" href="/pembimbing">
                                <span data-feather="users" class="align-text-bottom"></span>
                                Pembimbing
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @yield('active3')" href="/mahasiswa">
